...
export default function Preloader({ onComplete }: PreloaderProps) {
    ...
    useEffect(() => {
        const paths = pathsRef.current.filter((p) => p) as SVGPathElement[];

        gsap.set(paths, {
            strokeDasharray: (i) => paths[i].getTotalLength(),
    ...
    return (
        <div
            ref={preloaderRef}
            className="fixed inset-0 z-[100] flex items-center justify-center bg-gray-d"
        >
            <svg
                className="w-full h-auto max-w-[200px] text-green-d"
            ...
            >
                <g
                    id="dragon-path"
                    transform="translate(1024.000000, 1024.000000) scale(-0.100000, -0.100000)"
                >
                    <path
