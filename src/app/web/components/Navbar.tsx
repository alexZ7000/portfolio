...
export default function Navbar() {
    ...
    return (
        <nav className="w-full fixed z-50 backdrop-blur-xl bg-white/80 dark:bg-black/80 shadow-lg border-b border-white/10 dark:border-black/10 py-4 flex justify-center">
